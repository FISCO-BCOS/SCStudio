...
def detect_backdoor(fileName, timeout):
    
    dl_init()
    dl_clean()

    lineList, backdoorList = dl_run(fileName, timeout)
...
if __name__ == "__main__":
    ...
    lineList, backdoorList = detect_backdoor(fileName, timeout)
