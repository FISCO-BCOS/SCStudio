// Detail item template of each vulnerability
export var detailItem=
`<h2><span>Vulnerability: </span><code>!NAME!</code></h2>
<figure>
    <table>
        <thead>
            <tr>
...
<h3><span>Source Code</span></h3>
<p><code>!SOURCECODE!</code></p>`;
//Prefix template of detail vulnerability
...
<head>
    ...
    <title>analysis_report_detail</title>
    <style type='text/css'>
        html {
...
// Suffix template of the detail
export var detailSuffix=
`</div>
</body>
</html>`;
// Prefix template of the table
...
<body class='typora-export'>
    <div id='write' class='is-mac'>
        <blockquote>
            <p><span>Powered by SCStudio, a unified smart contract development platform produced by Tsinghua University
                    & WeBank. </span></p>
        </blockquote>
